        ...
        <div className="inventory-container">
            ...
            <div className="filter-container-yash">
                ...
                <div className="price-filter-yash">
                    <input type="number" className="price-input-y" placeholder="Min Price" value={minPrice} onChange={(e) => setMinPrice(e.target.value)} />
                    <input type="number" className="price-input-y" placeholder="Max Price" value={maxPrice} onChange={(e) => setMaxPrice(e.target.value)} />
                </div>
                                ...
                                <tr key={product._id}>
                                    <td>
                                        <a href={product.images[0]} target="_blank" rel="noopener noreferrer">
                                            <img src={product.images[0]} alt={product.name} className="product-img-yash" />
                                        </a>
                                    </td>
                                    <td>{product.name}</td>
